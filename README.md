...
untuk program yang digunakan untuk menghentikan program tadi, kita mencari pid dari program tadi dan menggunakan fungsi kill untuk menghentikannya. berikut potongan kodenya
```
char a[100];
